    ...
    return (
        ...
        <div className="max-w-7xl mx-auto pl-16 py-16 grid grid-cols-1 md:grid-cols-[1fr,2fr] gap-12">
          ...
          <div className={`${styles.textFadeIn} ${loaded ? styles.loaded : ''} text-white space-y-8`}>
            <div>
              <h1 className="text-3xl font-semibold">Welcome, Expert Researcher!</h1>
              <p className="mt-4 text-sm">Join our community of seasoned researchers and educators. As a tutor, you’ll have the opportunity to share your knowledge, mentor aspiring researchers, and contribute to the growth of the next generation of scholars.</p>
            </div>
