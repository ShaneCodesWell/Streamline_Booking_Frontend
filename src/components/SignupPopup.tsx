            ...
            <div className="bg-white rounded-3xl shadow-lg max-w-2xl w-full relative flex">
                ...
                <div className="w-1/3 bg-cover bg-center rounded-l-3xl p-6 relative" style={{ backgroundImage: 'url(/assets/images/popup-banner.png)' }}>
                    ...
                    <div className="flex flex-col items-center justify-center h-full  text-white">
                        <p className="text-2xl font-semibold mb-2">Welcome, 
                        Expert Researcher!</p>
                        <p className="text-xs">Join our community of seasoned researchers and educators. As a tutor, you’ll have the opportunity to share your knowledge, mentor aspiring researchers, and contribute to the growth of the next generation of scholars.</p>
                    </div>
                </div>
                ...
                <div className="w-2/3 p-8">
                    ...
                    <h2 className="text-xl text-gray-700 font-semibold mb-6">Create an account account</h2>
                    <form>
                        <div className="mb-4">
