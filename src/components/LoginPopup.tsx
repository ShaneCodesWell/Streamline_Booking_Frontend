...
export default function LoginPopup({ isOpen, onClose }: LoginPopupProps) {
    useEffect(() => {
        console.log('LoginPopup mounted or updated');
        
        // You can add any DOM manipulation or event listeners here

        return () => {
            console.log('LoginPopup unmounted');
            // Cleanup if necessary
        };
    }, [isOpen]);

    if (!isOpen) {
        console.log('LoginPopup is not open, returning null');
        return null; // Don't render the popup if it's not open
    }

    console.log('LoginPopup is open, rendering component');
